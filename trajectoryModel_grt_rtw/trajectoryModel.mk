###########################################################################
## Makefile generated for Simulink model 'trajectoryModel'. 
## 
## Makefile     : trajectoryModel.mk
## Generated on : Sun May 29 17:40:34 2016
## MATLAB Coder version: 2.7 (R2014b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/trajectoryModel
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = /Users/eugene/Desktop/workspace/circular_restricted_3_body_problem
ARCH                      = maci64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = trajectoryModel_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/trajectoryModel
...
INCLUDES_BUILDINFO = -I$(START_DIR)/trajectoryModel_grt_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
...
DEFINES_STANDARD = -DMODEL=trajectoryModel -DNUMST=2 -DNCSTATES=4 -DHAVESTDIO -DRT -DUSE_RTMODEL -DUNIX
...
SRCS = $(START_DIR)/trajectoryModel_grt_rtw/rtGetInf.c $(START_DIR)/trajectoryModel_grt_rtw/rtGetNaN.c $(START_DIR)/trajectoryModel_grt_rtw/rt_nonfinite.c $(START_DIR)/trajectoryModel_grt_rtw/trajectoryModel.c $(START_DIR)/trajectoryModel_grt_rtw/trajectoryModel_data.c rt_logging.c
...
OBJS = rtGetInf.o rtGetNaN.o rt_nonfinite.o trajectoryModel.o trajectoryModel_data.o rt_logging.o
...
%.o : $(START_DIR)/trajectoryModel_grt_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/trajectoryModel_grt_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
